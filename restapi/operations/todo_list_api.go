...
type TodoListAPI struct {
	...
	// JSONConsumer registers a consumer for a "application/todo-list.v1+json" mime type
	JSONConsumer runtime.Consumer

	// JSONProducer registers a producer for a "application/todo-list.v1+json" mime type
...
func (o *TodoListAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
	...
	for _, mt := range mediaTypes {
		...
		case "application/todo-list.v1+json":
			result["application/todo-list.v1+json"] = o.JSONConsumer
...
func (o *TodoListAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
	...
	for _, mt := range mediaTypes {
		...
		case "application/todo-list.v1+json":
			result["application/todo-list.v1+json"] = o.JSONProducer
